...
def main(event, context):
    ...
    video_id = event['queryStringParameters'].get('vid')
    # ユーザチェック
...
def call_create_video_api(user_id):
    url = f'https://v9kt9fos4k.execute-api.ap-northeast-1.amazonaws.com/dev/user/{user_id}/create/video?type=list'
    print(url)
